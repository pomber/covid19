...
- [covid-19 charts](https://lucid-mccarthy-7c7e30.netlify.com/): Yet another app with charts to compare the covid-19 outbreak per different countries. [repo](https://github.com/royriojas/corona/)
